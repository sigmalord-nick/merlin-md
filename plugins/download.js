...
cmd({
  ...
  try {
    ...
    const caption = `╭════ 〔 *MERLIN* 〕════❐\n`
      + `┃▸ *Description:* ${desc || "sigmalord nicks"}\n`
      + `╰═════════════════❐\n\n`
      + `📹 *Download Options:*\n`
      + `1️⃣  *SD Quality*\n`
      + `2️⃣  *HD Quality*\n`
...
cmd({
  ...
  try {
    ...
    const caption = `╭════ 〔 *MERLIN MD* 〕════❐\n`
      + `┃▢ *ғɪʟᴇ ɴᴀᴍᴇ:* ${file_name}\n`
      + `┃▢ *ғɪʟᴇ ᴛʏᴘᴇ:* ${mime_type}\n`
      + `╰═════════════════❐\n\n`
      + `> *Powered by Your sigmalordnicks🎐*`;
  ...
  try {
    ...
    if (downloadUrl) {
      ...
      await conn.sendMessage(from, {
        ...
        caption: "> *Powered by your sigmalord🎐*"
      }, { quoted: m });
